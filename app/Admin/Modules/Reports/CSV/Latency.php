...
class Latency extends DefaultCSV
{
    ...
    protected function getReportData() {
		...
		return HardwareHistory::select('hardware.mac', 'hardware.site', \DB::raw('AVG(hardware_history.latency) as latency'), 'hardware_history.updated AS updated')
